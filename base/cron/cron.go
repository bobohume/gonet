...
//第5列星期0～6（0表示星期天）
//*/5 * * * *   # every 5 minutes
//2 4 * * mon,fri'  # 04:02 on every Monday and Friday
//2 4 1 * wed   # 04:02 on every 1st day of the month if it is a Wednesday
//0 0 * * sat#1,sun#2'  # 每个月第一个周六，第二个周日的0点
//0 0 1 * *   # 每个月的1号的0点
//0,15,30,45 18-06 * * *   # 15minutes between 6pm and 6am
//10 1 * * 6,0  # 每周六、周日的1 : 10
//45 4 1,10,22 * *  # 每月1、10、22日的4 : 45
//第三方库croniter 参考 https://pypi.org/project/croniter/ 。 因项目需要，其中秒的支持改成了年份的支持
//维基 https://zh.wikipedia.org/wiki/Cron
//
//wiki https://en.wikipedia.org/wiki/Cron （这个完整一些）
