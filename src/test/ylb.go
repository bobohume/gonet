...
func main() {
	...
	var1 :=Sqltest{1, 2, "test", []uint{1, 2}, []int{3,4}, []Sqltest1{Sqltest1{1, 1}, Sqltest1{1, 1}},[2]Sqltest1{Sqltest1{1, 1}, Sqltest1{1, 1}}, []string{"tes21", "tes31"}, [2]bool{false,true},[2]float64{1, 2.2}, time.Now().Unix(), [2]bool{false,true}, time.Now().Unix(), }
