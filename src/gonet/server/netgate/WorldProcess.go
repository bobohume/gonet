...
func (this *WorldProcess) Init(num int) {
	...
	this.RegisterCall("COMMON_RegisterRequest", func(ctx context.Context) {
		SERVER.GetWorldCluster().SendMsg(rpc.RpcHead{ClusterId:this.m_ClusterId},"COMMON_RegisterRequest", &common.ClusterInfo{Type:message.SERVICE_GATESERVER, Ip:UserNetIP, Port:int32(base.Int(UserNetPort))})
	})
